        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-is-opening menu-open active">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{route('nguoi-dung.index')}}" class="nav-link active">
                            <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <a href="{{route('nha-cung-cap.create')}}" class="btn btn-primary pr-2">
                    ...
                    @foreach($user as $item)
                        <tr>
                            ...
                            <td>
                                @switch($item->role)
                                    @case('customer')
                                    <div class="text-info">Khách hàng</div>
                                    @break
                                    @case('superadmin')
                                    <div class="text-danger">Quản trị viên</div>
                                    @break
                                @endswitch
                            </td>
                            ...
                            <td class="d-flex">
{{--                                <form action="{{route('nguoi-dung.edit',$item->id)}}" method="get" class="pr-1">--}}
