    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-is-opening menu-open active">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{route('nguoi-dung.create')}}" class="nav-link active">
                            <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                @endif
                <div class="col-md-12">
                    <form action="{{ route('nguoi-dung.store') }}" method="POST" name="createadmin"  enctype="multipart/form-data" onSubmit="return valid();">
                        <div class="card card-primary">
                            <div class="card-header"><h3>Thêm thành viên</h3></div>
                            <div class="card-body col-md-6">

                                <!--Tạo token để chống tấn công CSRF (Cross-site Request Forgery)-->
                                @csrf
                                    <input type="hidden" name="_token" value="eNmyqDvXBPVKAtOjIu1j6sHEYNVx26QazvRyuAUs">
                                    <div class="form-group row">
                                        <label for="name" class="col-md-4 col-form-label text-md-right">Tên thành viên:</label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <select name="role" class="form-control" id="role">
                                                <option selected value="">--Chọn vai trò thành viên--</option>
        ...
        <script>
            function valid()
            {
                ...
                if(document.createadmin.name.value=="")
                {
                    alert("Tên đăng nhập không được bỏ trống !!");
                    document.createadmin.name.focus();
                    return false;
                }
                ...
                else if(document.createadmin.password.value.length<8)
                {
