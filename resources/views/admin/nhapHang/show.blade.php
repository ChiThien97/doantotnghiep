                        ...
                        <div class="card card-primary">
                                ...
                                <div class="card-body col-md-4">
                                    ...
                                    <div class="form-group row px-2">
                                        ...
                                        @foreach($nhacc as $item)
                                            @if($item->id == $pnh->id_nhacungcap)
                                            <input type="text" class="form-control" id="nhacungcap" value="{{$item->tennhacungcap}}" readonly/>
                                            @endif
                                        @endforeach
                                    </div>
                                    ...
                                    <div class="form-group row px-2">
                                        ...
                                        <input type="date" class="form-control" id="ngaytao" value="{{$pnh->created_at->format('Y-m-d')}}" readonly/>
                                    </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-12">
                                            <table class="table">
                                                ...
                                                <?php $total += $item['gianhap'] * $item['soluong'] ?>
                                                    <tr>
                                                        <td class="align-middle">
                                                            <img class="card-img-top" style="width: 100px" src="/images/{{$item['hinhanh']}}" alt="{{$item['tensanpham']}}">
                                                        </td>
                                                        <td class="align-middle">
                                                            {{$item['tensanpham']}}
                                                        </td>
                                                        <td class="align-middle quantity-outer" data-th="SỐ LƯỢNG">
                                                            <div class="counter">
                                                                <input class="quantity" id="quantity{{ $id }}" type="text" value="{{$item['soluong']}}" readonly>
                                                            </div>
                                                        </td>
                                                        <td class="text-primary align-middle">
                                                            <div class="input-group col-sm-9">
                                                                <input readonly type="text" id="gia{{ $id }}" value="{{number_format($item['gianhap'])}}" data-id="{{ $id }}" class="form-control price" required>
                                                        ...
                                                        <td class="text-primary align-middle">
                                                            <p class="text-danger total-price m-0" data-price="0" id="total{{ $id }}">{{number_format($item['gianhap']*$item['soluong'])}}</p>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                            ...
                            <div class="card-footer">
                                <div class="form-group">
                                    <div class="col-sm-3">
                                        <h3 type="submit" class="card-title">Chi tiết phiếu nhập hàng</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
