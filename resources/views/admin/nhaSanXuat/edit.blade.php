...
@section('content')
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('nha-san-xuat.index')}}">Danh sách</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('nha-san-xuat.update',$nhasx->id) }}" method="POST"  enctype="multipart/form-data">
                        <div class="card card-primary">
                            <div class="card-header"><h3>Sửa nhà sản xuất</h3></div>
                            ...
                            @method('PATCH')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="tennhasanxuat" type="text" class="form-control" id="name" value="{{$nhasx->tennhasanxuat}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="slug" type="text" class="form-control" id="slug" value="{{$nhasx->slug}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="mota" class="form-control" id="description">{{$nhasx->mota}}</textarea>
                                    </div>
                                </div>
