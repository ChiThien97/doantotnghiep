        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-is-opening menu-open active">
                ...
                <ul class="nav nav-treeview ">
                    ...
                    <li class="nav-item">
                        <a href="{{route('nha-san-xuat.index')}}" class="nav-link active">
                            <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <a href="{{route('nha-san-xuat.create')}}" class="btn btn-primary pr-2">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($nhasx as $item)
                        <tr>
                            ...
                            <td class="d-flex">
                                <form action="{{route('nha-san-xuat.edit',$item->id)}}" method="get" class="pr-1">
                                    <button class="btn btn-md btn-primary rounded-5">
                                        Sửa
                                    </button>
                                </form>
                                <form action="{{route('nha-san-xuat.destroy',$item->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
