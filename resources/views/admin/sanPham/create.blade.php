                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body col-md-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="id_loaisanpham" class="form-control custom-select" id="category-list" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="id_nhasanxuat" class="form-control custom-select" id="category-list" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="tensanpham" type="text" class="form-control" id="name" placeholder="VD: Tên sản phẩm">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="slug" type="text" class="form-control" id="slug" value="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-group col-sm-9">
                                        ...
                                        <input type="text" id="giakm" name="giakhuyenmai" class="form-control">
                                        <div class="input-group-append">
                                            <span class="input-group-text">đ</span>
                                        </div>
                                    </div>
...
{{--                                    <div class="col-sm-9">--}}
{{--                                        <textarea name="mota" class="form-control"  id="summernote" placeholder="Nhập mô tả vào đây ..."></textarea>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <script>--}}
{{--                                    $(function () {--}}
...
{{--                                </script>--}}
                                ...
                                <div class="form-group row">
                                    <label for="summernote" class="col-sm-3 col-form-label">Mô tả:</label>
                                    <div class="col-sm-9">
                                        <textarea name="mota" class="form-control summernote"  placeholder="Nhập mô tả vào đây ..."></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="thongso" class="form-control summernote" id="thongso" placeholder="Nhập thông số kỹ thuật vào đây ..."></textarea>
{{--                                        <textarea class="summernote" name="postdescription" required></textarea>--}}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-group col-sm-9">
                                        <input name="baohanh" type="number" class="form-control" id="baohanh" placeholder="VD: 12">
                                        <div class="input-group-append">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-group col-sm-9">
                                        <div class="custom-file">
                                            <input type="file" name="hinhanh" class="custom-file-input" id="InputFile">
                                ...
                                <div class="form-group checkbox switcher">
                                    <label for="status">
                                        ...
                                        <input type="checkbox" id="status" name="trangthai">
