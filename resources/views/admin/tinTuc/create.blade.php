                        ...
                        <div class="card card-primary">
                            ...
                            @php($admin_name = Auth::user()->name)
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="tieude" type="text" class="form-control" id="name" placeholder="VD: Tiêu đề tin tức công nghệ">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="noidung" class="form-control summernote"  placeholder="Nhập nội dung vào đây ..."></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group checkbox switcher">
                                    <label for="status">
                                        ...
                                        <input class="form-control" type="checkbox" id="status" name="trangthai">
