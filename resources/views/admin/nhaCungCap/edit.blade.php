...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('nha-cung-cap.update',$nhacc->id) }}" method="POST"  enctype="multipart/form-data">
                        <div class="card card-primary">
                            <div class="card-header"><h3>Sửa nhà cung cấp</h3></div>
                            ...
                            @method('PATCH')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="tennhacungcap" type="text" class="form-control" id="name" value="{{$nhacc->tennhacungcap}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="diachi" type="text" class="form-control" id="addr" value="{{$nhacc->diachi}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="email" type="email" class="form-control" id="mail" value="{{$nhacc->email}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="sodienthoai" type="text" class="form-control" id="sdt" value="{{$nhacc->sodienthoai}}">
                                    </div>
                                </div>
