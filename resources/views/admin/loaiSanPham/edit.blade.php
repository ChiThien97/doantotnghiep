...
@section('content')
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-is-opening menu-open active">
                ...
                <ul class="nav nav-treeview" style="display: block;">
                    ...
                    <li class="nav-item">
                        <a href="{{route('loai-san-pham.index')}}"  class="nav-link active">
                            <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('loai-san-pham.index')}}">Danh sách</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('loai-san-pham.update',$loaisp->id) }}" method="POST"  enctype="multipart/form-data">
                        <div class="card card-primary">
                            <div class="card-header"><h3>Sửa loại sản phẩm</h3></div>
                            <div class="card-body col-md-6">
                                @method('PATCH')
                                <!--Tạo token để chống tấn công CSRF (Cross-site Request Forgery)-->
                                @csrf
                                <div class="form-group row">
                                    <label for="nameCate" class="col-sm-3 col-form-label">Tên loại:</label>
                                    <div class="col-sm-9">
                                        <input name="tenloai" type="text" class="form-control" id="name" value="{{ $loaisp->tenloai}}" >
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="nameCate" class="col-sm-3 col-form-label">Slug:</label>
                                    <div class="col-sm-9">
                                        <input name="slug" type="text" class="form-control" id="slug" value="{{ $loaisp->slug}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="mota" class="form-control summernote" id="description">{{ $loaisp->mota}}</textarea>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="category-list">Loại sản phẩm cha : </label>
                                    <div class="col-sm-9">
                                        <select name="id_parent" class="form-control custom-select rounded-0" id="category-list">
                                            <option value="0">--Chọn loại sản phẩm--</option>
                                            @foreach($loaisps as $item)
                                                @if($item->id == $loaisp->id_parent)
                                                    <option value="{{ $item->id }}" selected>{{ $item->tenloai }}</option>
                                                @elseif($item->id!=$loaisp->id)
