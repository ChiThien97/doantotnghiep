...
@section('content')
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-is-opening menu-open active">
                ...
                <ul class="nav nav-treeview" style="display: block;">
                    <li class="nav-item">
                        <a href="{{route('loai-san-pham.create')}}" class="nav-link active">
                            <i class="far fa-circle nav-icon"></i>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('loai-san-pham.store') }}" method="POST"  enctype="multipart/form-data">
                    <div class="card card-primary">
                    <div class="card-header"><h3>Thêm loại sản phẩm mới</h3></div>
                    <div class="card-body col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="tenloai" type="text" class="form-control" id="name" placeholder="VD: Tên loại sản phẩm">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="slug" type="text" class="form-control" id="slug" placeholder="VD: ten-loai-san-pham">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="mota" class="form-control summernote" id="description" placeholder="Nhập mô tả  vào đây ..."></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="id_parent" class="form-control custom-select" id="category-list" required>
